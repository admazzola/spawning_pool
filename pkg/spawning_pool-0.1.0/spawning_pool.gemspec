# -*- encoding: utf-8 -*-
# stub: spawning_pool 0.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "spawning_pool"
  s.version = "0.1.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 1.2") if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib"]
  s.authors = ["Andrew Mazzola"]
  s.date = "2016-02-12"
  ...
  s.summary = "A rake task manager to allow migrating and rollbacks for any of your tasks."
end
